...
//    {
//        return ( this.victim.isPotionActive(MobEffects.NAUSEA) || this.victim.isPotionActive(MobEffects.BLINDNESS) );
//    }
...
//        {
//            ((WorldServer)e.world).spawnParticle(EnumParticleTypes.SPELL_MOB,e.posX+d0,e.posY+(double)e.getEyeHeight(),e.posZ+d1, 4, d0, 0.0D, d1, 0.001D);
//        }
//    }
//    
